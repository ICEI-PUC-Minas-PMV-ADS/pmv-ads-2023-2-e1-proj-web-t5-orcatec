...
btnSalvar.onclick = e => {
    ...
    if (sNome.value == '' || sEmpresa.value == '' || sContato.value == '' || sCPF.value == '' || sCidade.value == '') {
        return
    }
    ...
    if (id !== undefined) {
        ...
        itens.push({ 'nome': sNome.value, 'empresa': sEmpresa.value, 'contato': sContato.value, 'cpf': sCPF.value, 'cidade': sCidade.value })
    }
